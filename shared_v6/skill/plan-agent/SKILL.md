...
<!-- @contract plan-agent-proposal-resolution-ownership -->
<!-- @anchor plan-agent-proposal-resolution-caller-mapping -->
...
<!-- @contract plan-agent-programmatic-flows -->
...
<!-- @anchor review-dispatch-procedure -->
...
<!-- @anchor plan-agent-publication-loader -->
...
```
<!-- @anchor plan-agent-publication-outcomes -->
...
<!-- @anchor plan-candidate-producer-start -->
...
<!-- @anchor plan-candidate-producer-stop-boundary -->
<!-- @contract plan-agent-plan-candidate-producer-handoff -->
...
<!-- @anchor structural-health-gate-start -->
<!-- @contract plan-agent-structural-health-handoff -->
...
<!-- @contract plan-agent-review-routing -->
...
<!-- @contract plan-agent-destination-selection -->
## destination selection

semantic completion eligibility が成立したあと、親は Agentic destination 確定の前に次の Loader Data で `destination-selection` を一度だけ load し、identity と必要本文を検証する。失敗時は推測で destination を確定せず、既存の `incomplete` へ返す。
...
<!-- @contract plan-agent-artifact-completion -->
## local artifact completion
