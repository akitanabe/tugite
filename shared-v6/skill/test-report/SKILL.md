...
<!-- @contract test-report-invocation -->
...
<!-- @contract test-report-read-only -->
テスト・コード・成果物の編集、実装、委譲、Worker 起動、後続 Action を行わない。テスト・対象コードの実行も行わない。
観測は静的読解に限る。
<!-- @/contract -->

<!-- @contract test-report-non-evaluation -->
...
<!-- @contract test-report-kernel-loader -->
...
<!-- @contract test-report-reconstruction -->
...
<!-- @contract test-report-verification-means -->
...
<!-- @contract test-report-execution-state -->
...
<!-- @contract test-report-gap-overlay -->
