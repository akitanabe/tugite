...
意思決定の明確化）の6つです。internal skill は `plan-candidate-producer`、`structural-health-gate`、`work-unit-design` の3つです。
...
programmatic_flow_excluded_skills = ["clarify-it", "code-review", "structural-health-gate", "work-unit-design"]
