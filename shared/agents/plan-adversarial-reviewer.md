...
[codex]
description = "Stateless adversarial reviewer of an immutable Plan snapshot, actively searching within current authority for grounded failure paths that break acceptance criteria, verifiability, or feasibility."
model = "gpt-5.6-sol"
...
name: plan-adversarial-reviewer
description: >-
  呼び出し元が渡す immutable Plan snapshot を current authority 内で反証し、AC 充足・検証可能性・実行可能性を壊す concrete failure path を能動的に探索する stateless reviewer。
model: cursor-grok-4.6-high
readonly: true
---
<!-- @/only -->
