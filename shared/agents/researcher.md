...
[codex]
description = "Acquire caller-scoped local or external Web evidence and perform bounded analysis within a caller-defined objective, scope, and authority."
model = "gpt-5.6-luna"
...
name: researcher
description: >-
  bounded objective の内側で caller-scoped な local / external Web evidence acquisition と局所分析を行い、grounded result を返す Research Agent。
model: composer-2.5
---
<!-- @/only -->
...
<!-- @contract shared-researcher-web-boundary -->
...
<!-- @contract shared-researcher-web-egress -->
...
<!-- @contract shared-researcher-web-result-trace -->
