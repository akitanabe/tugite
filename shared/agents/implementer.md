...
[codex]
description = "Tugite workflow implementer for clear, bounded implementation or test branches with low or medium implementation_complexity and low judgment density. Use only when the parent agent explicitly delegates a normal implementation branch; choose implementer when routing is uncertain."
model = "gpt-5.6-luna"
