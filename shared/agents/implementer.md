...
[codex]
description = "agentic-qa-workflow workflow implementer for clear, bounded implementation or test branches. Use only when the parent agent explicitly delegates a normal implementation branch."
model = "gpt-5.6-luna"
