...
<!-- @contract static-performance-input-policy -->
performance 専用の必須 input は追加しません。
<!-- @/contract -->

<!-- @contract static-performance-context -->
...
<!-- @contract static-performance-pre-verdict -->
...
<!-- @contract static-performance-evidence-scope -->
...
<!-- @contract static-performance-no-runtime-measurement -->
...
<!-- @contract static-performance-hot-path-policy -->
...
<!-- @contract static-performance-verdict-output -->
...
<!-- @contract static-performance-finding-evidence -->
