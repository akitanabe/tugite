...
<!-- @anchor destination-selection-boundary-relation -->
<!-- @contract destination-selection-boundary -->
...
<!-- @anchor destination-selection-trigger-relation -->
<!-- @contract destination-selection-trigger -->
...
<!-- @anchor destination-selection-flow-inputs-relation -->
<!-- @contract destination-selection-flow-inputs -->
...
<!-- @anchor destination-selection-resume-relation -->
<!-- @contract destination-selection-resume -->
...
<!-- @anchor destination-selection-resume-result-relation -->
<!-- @contract destination-selection-resume-result -->
...
<!-- @anchor destination-selection-qualification-relation -->
<!-- @contract destination-selection-qualification -->
...
<!-- @anchor destination-selection-requested-relation -->
<!-- @contract destination-selection-requested -->
...
<!-- @anchor destination-selection-cardinality-relation -->
<!-- @contract destination-selection-cardinality -->
...
<!-- @anchor destination-selection-outcomes-relation -->
<!-- @contract destination-selection-outcomes -->
- selected destination、qualified set、unresolved destination gap、または reason と evidence を伴う `incomplete` を返す。
<!-- @/contract -->

<!-- @contract destination-selection-resume-outcome -->
...
<!-- @contract destination-selection-state-ownership -->
