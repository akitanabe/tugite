...
<!-- @contract navigate-way-explicit-only -->
...
<!-- @contract navigate-way-destination-selection -->
...
<!-- @contract navigate-way-non-goals -->
...
<!-- @contract navigate-way-local-model -->
...
<!-- @contract navigate-way-decision-unit -->
...
<!-- @contract navigate-way-resolution-boundary -->
...
<!-- @contract navigate-way-reintegration -->
...
<!-- @contract navigate-way-work-unit -->
...
<!-- @contract navigate-way-persistence -->
...
<!-- @contract navigate-way-completion-disposition -->
...
<!-- @contract navigate-way-flow -->
<!-- @anchor navigate-way-flow-trigger -->
Trigger: 親 `navigate-way` が current Map の semantic judgment と completion facts を確定した。

<!-- @anchor navigate-way-flow-inputs -->
...
<!-- @anchor navigate-way-flow-step-1 -->
...
<!-- @anchor navigate-way-flow-step-4 -->
...
<!-- @anchor navigate-way-flow-step-5 -->
...
<!-- @anchor navigate-way-flow-outcomes -->
Outcomes:
