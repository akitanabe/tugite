...
<!-- @contract wayfind-explicit-only -->
...
<!-- @contract wayfind-destination-selection -->
...
<!-- @contract wayfind-decision-unit -->
...
<!-- @contract wayfind-resolution-boundary -->
...
<!-- @contract wayfind-reintegration -->
...
<!-- @contract wayfind-completion-disposition -->
