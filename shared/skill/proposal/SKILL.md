...
<!-- @contract proposal-batch-resolve-kernel-loader -->
## batch-resolve-kernel v1 の parent mapping

<!-- @anchor proposal-batch-resolve-kernel-loader-start -->
...
<!-- @anchor proposal-batch-resolve-kernel-use -->
検証済み本文だけを、以降の Resolution Transaction の既存の `判定基準` または `必要な周辺 context` に注入する。
<!-- @/contract -->

<!-- @contract proposal-batch-resolution-role-mapping -->
...
<!-- @anchor proposal-batch-resolution-transaction-start -->
<!-- @contract proposal-batch-resolution-transaction -->
...
<!-- @contract proposal-two-advisor-passes -->
