...
<!-- @contract review-refine-plan-family-caller -->
...
<!-- @contract review-refine-structural-boundary -->
...
<!-- @contract review-refine-batch-resolve-kernel-parent-mapping -->
## batch-resolve-kernel-v1 の parent mapping

<!-- @anchor review-refine-batch-loader-start -->
次の Loader Data が列挙値の唯一の正本である。
