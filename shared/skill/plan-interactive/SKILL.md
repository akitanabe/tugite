...
<!-- @anchor plan-interactive-kernel-load -->
...
<!-- @anchor plan-interactive-clarify-start -->
...
<!-- @anchor plan-interactive-structural-health-gate-start -->
...
<!-- @anchor plan-interactive-review-refine-handoff -->
## review の適用と固定順序
...
<!-- @contract plan-interactive-handoff -->
...
<!-- @contract plan-interactive-necessity-parent -->
...
<!-- @contract plan-interactive-advisor-parent -->
...
<!-- @contract plan-interactive-verification-derivation -->
...
<!-- @contract plan-interactive-programmatic-flows -->
以下は final acceptance または明示 opt-out の後に、親が exact target を確定して渡した publication routing だけを持つ。

### local-artifact-completion

<!-- @anchor plan-interactive-final-acceptance-complete -->
Trigger: final acceptance が完了した、または Human が final acceptance を明示 opt-out し、親が exact `publication_target` を確定したとき。
<!-- @anchor plan-interactive-publication-inputs -->
Inputs: final acceptance / opt-out Data、凍結した成果物本文 bytes、および親確定の `publication_target` Data。`publication_target` は existing destination の observed destination object identity、または OS-temp の verified temp-root identity / exact run-owned directory path / exclusive creation intent の排他的 Data を持ち、作成前の directory object identity を要求しない。
<!-- @anchor plan-interactive-publication-loader -->
...
```
<!-- @anchor plan-interactive-publication-outcomes -->
...
<!-- @contract plan-interactive-clarify-loop-bound-routing -->
...
<!-- @contract plan-interactive-direction-freeze-projection -->
...
<!-- @contract plan-interactive-optional-proposal-refinement-routing -->
...
<!-- @contract plan-interactive-freeze-integrity-recovery-routing -->
...
<!-- @contract plan-interactive-structural-gate-reopen-routing -->
...
<!-- @contract plan-interactive-fixed-review-routing -->
...
<!-- @contract plan-interactive-final-acceptance-routing -->
