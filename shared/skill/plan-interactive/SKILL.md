...
description: >-
  ...
  direction freeze 後に mandatory な common Plan synthesis、structural gate、bounded review を通し、
  最終結果を人間へ返す。実装・委譲・次工程の自動前進は行わない。
disable-model-invocation: true
---
<!-- @/only -->
...
<!-- @anchor plan-interactive-constrained-producer-start -->
<!-- @contract plan-interactive-producer-ownership -->
...
<!-- @anchor plan-interactive-freeze-integrity-start -->
<!-- @contract plan-interactive-freeze-integrity -->
## freeze-integrity
...
<!-- @contract plan-interactive-structural-health-gate -->
...
<!-- @contract plan-interactive-local-artifact-completion -->
...
<!-- @contract plan-interactive-constrained-producer-routing -->
...
<!-- @contract plan-interactive-freeze-integrity-routing -->
...
<!-- @contract plan-interactive-review-dispatch -->
### review-dispatch
