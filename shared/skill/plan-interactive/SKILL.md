...
<!-- @anchor plan-interactive-document-relation -->
# plan-interactive
...
<!-- @contract plan-interactive-ownership -->
<!-- @anchor plan-interactive-ownership-relation -->
...
<!-- @contract plan-interactive-authority -->
<!-- @anchor plan-interactive-authority-relation -->
...
<!-- @contract plan-interactive-core-input -->
<!-- @anchor plan-interactive-core-input-relation -->
...
<!-- @contract plan-interactive-authority-preservation -->
<!-- @anchor plan-interactive-authority-preservation-relation -->
...
<!-- @contract plan-interactive-incomplete -->
<!-- @anchor plan-interactive-incomplete-relation -->
...
<!-- @contract plan-interactive-human-boundary -->
<!-- @anchor plan-interactive-human-boundary-relation -->
...
<!-- @contract plan-interactive-result -->
<!-- @anchor plan-interactive-result-relation -->
...
<!-- @contract plan-interactive-plan-only -->
<!-- @anchor plan-interactive-plan-only-relation -->
