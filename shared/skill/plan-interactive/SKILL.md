...
<!-- @contract plan-interactive-execution-bound -->
...
<!-- @contract plan-interactive-observation-reapply -->
...
<!-- @contract plan-interactive-clarify-projection -->
...
<!-- @contract plan-interactive-reopen-routing -->
...
<!-- @contract plan-interactive-refinement-selection -->
```text
...
<!-- @contract plan-interactive-refinement-stop -->
```text
...
<!-- @contract plan-interactive-check1-recovery -->
```text
