...
<!-- @contract implementation-unit-design-internal-guard -->
## 位置づけと発火
...
<!-- @contract implementation-unit-design-caller-selected-input -->
...
<!-- @contract implementation-unit-design-partition-input-data -->
...
<!-- @contract implementation-unit-design-partition-attention -->
...
<!-- @contract implementation-unit-design-partition-remediation-binding -->
...
<!-- @contract implementation-unit-design-implementation-unit-data-consumer -->
...
<!-- @contract implementation-unit-design-rmo-parent-mapping -->
...
3. 一つの候補内に独立した purpose、AC、verification、accept と rollback の境界が複数ある場合は split する。foundation は
   ...
   最初に振る舞い価値を生む単位が所有する。
<!-- @contract implementation-unit-design-partition-contrastive-guard -->
...
<!-- @contract implementation-unit-design-partition-casebook -->
...
<!-- @contract implementation-unit-design-partition-casebook-initial-over-merge -->
...
<!-- @/contract -->
<!-- @contract implementation-unit-design-partition-casebook-kernel-caller -->
...
<!-- @/contract -->
<!-- @contract implementation-unit-design-partition-casebook-oversplit -->
...
<!-- @/contract -->
<!-- @contract implementation-unit-design-casebook-shared-surface -->
...
<!-- @/contract -->
<!-- @contract implementation-unit-design-casebook-hidden-dependency -->
...
<!-- @/contract -->
<!-- @contract implementation-unit-design-casebook-false-verification -->
...
<!-- @/contract -->
<!-- @contract implementation-unit-design-casebook-foundation-application -->
...
<!-- @/contract -->
<!-- @contract implementation-unit-design-casebook-incidental-finding -->
...
<!-- @/contract -->
<!-- @contract implementation-unit-design-casebook-cardinality-one -->
...
<!-- @contract implementation-unit-design-casebook-observation-points -->
