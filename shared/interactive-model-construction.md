...
Interactive Method は、`explorer-this`、`plan-interactive`、`whats-this`、または任意の downstream workflow を自律的に起動しない。
...
- Method switching、`explorer-this` からの fallback、`whats-this`、`plan-interactive`、Planning Synthesis、downstream artifact / plan の acceptance
