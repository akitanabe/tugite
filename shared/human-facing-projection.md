...
<!-- @contract human-facing-projection-identity -->
...
<!-- @contract human-facing-projection-input -->
caller は意味・構成・tone と出力用途を確定した通常の文章を入力します。固定 schema、mode 指定、用語対応表、変換ログを要求しません。
<!-- @/contract -->

<!-- @contract human-facing-projection-semantic-boundary -->
...
<!-- @contract human-facing-projection-reapplication -->
...
<!-- @contract human-facing-projection-safe -->
...
<!-- @contract human-facing-projection-code -->
...
<!-- @contract human-facing-projection-signals -->
- 内部抽象語への依存
- 説明目的の英語混在
- 条件・対象・動作の過剰な圧縮
- 追いにくい修飾関係
