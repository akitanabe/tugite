...
<!-- @contract shared-model-continuation -->
<!-- @anchor shared-model-continuation-relation -->
...
<!-- @contract shared-model-continuation-reusability -->
<!-- @anchor shared-model-continuation-reusability-relation -->
...
<!-- @contract shared-model-continuation-same-surface -->
source / evidence surface の同一性を material reusability の前提にしない。
<!-- @/contract -->

<!-- @contract shared-model-continuation-preference -->
materially reusable と判断できる場合、caller は same runtime instance への continuation を fresh invocation より優先できる。
<!-- @/contract -->

<!-- @contract shared-model-continuation-fresh -->
<!-- @anchor shared-model-continuation-fresh-relation -->
